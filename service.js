    ...
    const filePaths = {
        "Building Permit": {
            guideImages: ["guides/BuildingPermit-Procedure-1.png", "guides/BuildingPermit-Procedure-2.png"],
            requirementsPdfs: ["requirements/BuildingPermit-Requirements.pdf"],
            applicationPdfs: ["application/BuildingPermit-Application.pdf"] 
        },
        "Electrical Permit": {
            guideImages: ["guides/ElectricalPermit-Procedure-1.png", "guides/ElectricalPermit-Procedure-2.png"],
            requirementsPdfs: ["requirements/ElectricalPermit-Requirements.pdf"],
            applicationPdfs: ["application/ElectricalPermit-Application.pdf"]
        },
        "Demolition Permit": {
            guideImages: ["guides/DemolitionPermit-Procedure-1.png", "guides/DemolitionPermit-Procedure-2.png"],
            requirementsPdfs: ["requirements/DemolitionPermit-Requirements.pdf"],
            applicationPdfs: ["application/DemolitionPermit-Application.pdf"]
        },
        "Business Permit": {
            guideImages: ["guides/BusinessPermit-Procedure-1.png", "guides/BusinessPermit-Procedure-2.png"],
            requirementsPdfs: ["requirements/BusinessPermit-Requirements.pdf"],
            applicationPdfs: ["application/BusinessPermit-Application.pdf"]
        },
        "Sanitary Permit": {
            guideImages: ["guides/SanitaryPermit-Procedure-1.png", "guides/SanitaryPermit-Procedure-2.png"],
            requirementsPdfs: ["requirements/SanitaryPermit-Requirements.pdf"],
            applicationPdfs: ["application/SanitaryPermit-Application.pdf"]
        },
        "Birth Certificate": {
            guideImages: ["guides/BirthCertificate-Procedure-1.png", "guides/BirthCertificate-Procedure-2.png"],
            requirementsPdfs: ["requirements/BirthCertificate-Requirements.pdf"],
            applicationPdfs: ["application/BirthCertificate-Application.pdf"]
        },
        "Marriage License": {
            guideImages: ["guides/MarriageLicense-Procedure-1.png", "guides/MarriageLicense-Procedure-2.png"],
            requirementsPdfs: ["requirements/MarriageLicense-Requirements.pdf"],
            applicationPdfs: ["application/MarriageLicense-Application.pdf"]
        },
        "Death Certificate": {
            guideImages: ["guides/DeathCertificate-Procedure-1.png", "guides/DeathCertificate-Procedure-2.png"],
            requirementsPdfs: ["requirements/DeathCertificate-Requirements.pdf"],
            applicationPdfs: ["application/DeathCertificate-Application.pdf"]
        },
        "Certificate of Indigency": {
            guideImages: ["guides/CertificateofIndigency-Procedure-1.png", "guides/CertificateofIndigency-Procedure-2.png"],
            requirementsPdfs: ["requirements/CertificateofIndigency-Requirements.pdf"],
            applicationPdfs: ["application/CertificateofIndigency-Application.pdf"]
        },
        "Police Clearance": {
            guideImages: ["guides/PoliceClearance-Procedure-1.png", "guides/PoliceClearance-Procedure-2.png"],
            requirementsPdfs: ["requirements/PoliceClearance-Requirements.pdf"],
            applicationPdfs: ["application/PoliceClearance-Application.pdf"]
        },
        "Certificate of Environment Clearance": {
            guideImages: ["guides/CEC-Procedures-1.png", "guides/CEC-Procedures-2.png"],
            requirementsPdfs: ["requirements/CEC-Requirements.pdf"],
            applicationPdfs: ["application/ECClearance-Application.pdf"]
        },
        "Fire Safety Evaluation Clearance": {
            guideImages: ["guides/FSEC-Procedure-1.png", "guides/FSEC-Procedure-2.png"],
            requirementsPdfs: ["requirements/FSEC-Requirements.pdf"],
            applicationPdfs: ["application/FSEClearance-Application.pdf"]
        },
        "CENOMAR Certificate": {
            guideImages: ["guides/CENOMAR-Procedure-1.png", "guides/CENOMAR-Procedure-2.png"],
            requirementsPdfs: ["requirements/CENOMAR-Requirements.pdf"],
            applicationPdfs: ["application/CENOMARCertificate-Application.pdf"]
        },
        "Medical Certificate": {
            guideImages: ["guides/MedicalCertificate-Procedure-1.png"],
            requirementsPdfs: ["requirements/MedicalCertificate-Requirements.pdf"],
            applicationPdfs: ["application/MedicalCertificate-Application.pdf"]
        },
    };
...
const contentData = {
    ...
    const showTab = (tabId) => {
        ...
        if (tabId === 'guide') {
            document.getElementById('guide-content').innerHTML = createGuideUI();
            updateGuideContent(currentService, selectedServiceType);
        } else if (tabId === 'requirements') {
            document.getElementById('requirements-content').innerHTML = createRequirementsUI();
            updateRequirementsContent(currentService, selectedServiceType);
        } else if (tabId === 'application') {
            document.getElementById('application-content').innerHTML = createApplicationUI();
            updateApplicationContent(currentService, selectedServiceType);
        } else if (tabId === 'upload') {
            document.getElementById('upload-content').innerHTML = createUploadUI(
            ...
            document.getElementById('process-content').innerHTML = createProcessUI(currentService);
        } else if (tabId === 'department') {
            document.getElementById('department-content').innerHTML = createDepartmentUI(currentService);
        }
